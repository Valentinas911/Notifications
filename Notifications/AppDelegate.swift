...
import UIKit
import UserNotifications //necessary in order do have notifications when app is in foreground
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UNUserNotificationCenter.current().delegate = self //This is necessary in order do have notifications when app is in foreground
...
// Below is necessary in order do have notifications when app is in foreground
